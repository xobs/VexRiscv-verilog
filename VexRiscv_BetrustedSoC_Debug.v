...
module VexRiscv (
  ...
  wire  _zz_86_;
  wire  _zz_87_;
  wire `Src2CtrlEnum_defaultEncoding_type _zz_88_;
  wire  _zz_89_;
  wire  _zz_90_;
  wire  _zz_91_;
  wire  _zz_92_;
  ...
  wire  _zz_186_;
  wire  _zz_187_;
  wire `Src2CtrlEnum_defaultEncoding_type _zz_188_;
  wire `EnvCtrlEnum_defaultEncoding_type _zz_189_;
  wire `BranchCtrlEnum_defaultEncoding_type _zz_190_;
  wire `AluCtrlEnum_defaultEncoding_type _zz_191_;
  wire `ShiftCtrlEnum_defaultEncoding_type _zz_192_;
  wire `Src1CtrlEnum_defaultEncoding_type _zz_193_;
  wire `AluBitwiseCtrlEnum_defaultEncoding_type _zz_194_;
  ...
  reg [23:0] _zz_88__string;
  reg [31:0] decode_BRANCH_CTRL_string;
  reg [31:0] _zz_100__string;
  reg [23:0] _zz_188__string;
  reg [39:0] _zz_189__string;
  reg [31:0] _zz_190__string;
  reg [63:0] _zz_191__string;
  reg [71:0] _zz_192__string;
  reg [95:0] _zz_193__string;
  reg [39:0] _zz_194__string;
  ...
  assign _zz_316_ = (writeBack_arbitration_isValid && writeBack_REGFILE_WRITE_VALID);
  assign _zz_317_ = 1'b1;
  assign _zz_318_ = (memory_arbitration_isValid && memory_REGFILE_WRITE_VALID);
  assign _zz_319_ = (execute_arbitration_isValid && execute_REGFILE_WRITE_VALID);
  assign _zz_320_ = (memory_arbitration_isValid && memory_IS_DIV);
  assign _zz_321_ = ((_zz_269_ && IBusCachedPlugin_cache_io_cpu_decode_error) && (! _zz_97_));
  assign _zz_322_ = ((_zz_269_ && IBusCachedPlugin_cache_io_cpu_decode_cacheMiss) && (! _zz_98_));
  assign _zz_323_ = ((_zz_269_ && IBusCachedPlugin_cache_io_cpu_decode_mmuException) && (! _zz_99_));
  assign _zz_324_ = ((_zz_269_ && IBusCachedPlugin_cache_io_cpu_decode_mmuRefilling) && (! 1'b0));
  assign _zz_325_ = ({decodeExceptionPort_valid,IBusCachedPlugin_decodeExceptionPort_valid} != (2'b00));
  assign _zz_326_ = (execute_arbitration_isValid && (execute_ENV_CTRL == `EnvCtrlEnum_defaultEncoding_WFI));
  assign _zz_327_ = (execute_arbitration_isValid && execute_DO_EBREAK);
  assign _zz_328_ = (({writeBack_arbitration_isValid,memory_arbitration_isValid} != (2'b00)) == 1'b0);
  assign _zz_329_ = (! memory_DivPlugin_div_done);
  assign _zz_330_ = (CsrPlugin_hadException || CsrPlugin_interruptJump);
  assign _zz_331_ = (writeBack_arbitration_isValid && (writeBack_ENV_CTRL == `EnvCtrlEnum_defaultEncoding_XRET));
  assign _zz_332_ = (DebugPlugin_stepIt && IBusCachedPlugin_incomingInstruction);
  assign _zz_333_ = writeBack_INSTRUCTION[29 : 28];
  assign _zz_334_ = (IBusCachedPlugin_iBusRsp_output_valid && IBusCachedPlugin_iBusRsp_output_ready);
  assign _zz_335_ = ((! (((! IBusCachedPlugin_decompressor_isRvc) && (! IBusCachedPlugin_iBusRsp_output_payload_pc[1])) && (! IBusCachedPlugin_decompressor_bufferValid))) && (! ((IBusCachedPlugin_decompressor_isRvc && IBusCachedPlugin_iBusRsp_output_payload_pc[1]) && IBusCachedPlugin_decompressor_decodeInput_ready)));
  assign _zz_336_ = (! IBusCachedPlugin_iBusRsp_readyForError);
  assign _zz_337_ = (! ({(writeBack_arbitration_isValid || CsrPlugin_exceptionPendings_3),{(memory_arbitration_isValid || CsrPlugin_exceptionPendings_2),(execute_arbitration_isValid || CsrPlugin_exceptionPendings_1)}} != (3'b000)));
  assign _zz_338_ = (! dataCache_1__io_cpu_redo);
  assign _zz_339_ = (writeBack_arbitration_isValid && writeBack_MEMORY_ENABLE);
  assign _zz_340_ = (writeBack_arbitration_isValid && writeBack_REGFILE_WRITE_VALID);
  assign _zz_341_ = (1'b0 || (! 1'b1));
  assign _zz_342_ = (memory_arbitration_isValid && memory_REGFILE_WRITE_VALID);
  assign _zz_343_ = (1'b0 || (! memory_BYPASSABLE_MEMORY_STAGE));
  assign _zz_344_ = (execute_arbitration_isValid && execute_REGFILE_WRITE_VALID);
  assign _zz_345_ = (1'b0 || (! execute_BYPASSABLE_EXECUTE_STAGE));
  assign _zz_346_ = execute_INSTRUCTION[13 : 12];
  assign _zz_347_ = (! memory_arbitration_isStuck);
  assign _zz_348_ = (execute_CsrPlugin_illegalAccess || execute_CsrPlugin_illegalInstruction);
  assign _zz_349_ = (execute_arbitration_isValid && (execute_ENV_CTRL == `EnvCtrlEnum_defaultEncoding_ECALL));
  assign _zz_350_ = ((MmuPlugin_dBusAccess_rsp_valid && (! MmuPlugin_dBusAccess_rsp_payload_redo)) && (MmuPlugin_shared_dBusRsp_leaf || MmuPlugin_shared_dBusRsp_exception));
  assign _zz_351_ = (MmuPlugin_shared_portId == (1'b1));
  assign _zz_352_ = (MmuPlugin_shared_portId == (1'b0));
  assign _zz_353_ = debug_bus_cmd_payload_address[7 : 2];
  assign _zz_354_ = (iBus_cmd_valid || (_zz_255_ != (3'b000)));
  assign _zz_355_ = (_zz_289_ && (! dataCache_1__io_mem_cmd_s2mPipe_ready));
  assign _zz_356_ = ((CsrPlugin_sstatus_SIE && (CsrPlugin_privilege == (2'b01))) || (CsrPlugin_privilege < (2'b01)));
  assign _zz_357_ = ((_zz_225_ && (1'b1 && CsrPlugin_mideleg_ST)) && (! 1'b0));
  assign _zz_358_ = ((_zz_226_ && (1'b1 && CsrPlugin_mideleg_SS)) && (! 1'b0));
  assign _zz_359_ = ((_zz_227_ && (1'b1 && CsrPlugin_mideleg_SE)) && (! 1'b0));
  assign _zz_360_ = (CsrPlugin_mstatus_MIE || (CsrPlugin_privilege < (2'b11)));
  assign _zz_361_ = ((_zz_225_ && 1'b1) && (! (CsrPlugin_mideleg_ST != (1'b0))));
  assign _zz_362_ = ((_zz_226_ && 1'b1) && (! (CsrPlugin_mideleg_SS != (1'b0))));
  assign _zz_363_ = ((_zz_227_ && 1'b1) && (! (CsrPlugin_mideleg_SE != (1'b0))));
  assign _zz_364_ = ((_zz_228_ && 1'b1) && (! 1'b0));
  assign _zz_365_ = ((_zz_229_ && 1'b1) && (! 1'b0));
  assign _zz_366_ = ((_zz_230_ && 1'b1) && (! 1'b0));
  assign _zz_367_ = (IBusCachedPlugin_mmuBus_cmd_isValid && IBusCachedPlugin_mmuBus_rsp_refilling);
  assign _zz_368_ = (DBusCachedPlugin_mmuBus_cmd_isValid && DBusCachedPlugin_mmuBus_rsp_refilling);
  assign _zz_369_ = (MmuPlugin_ports_0_entryToReplace_value == (2'b00));
  assign _zz_370_ = (MmuPlugin_ports_0_entryToReplace_value == (2'b01));
  assign _zz_371_ = (MmuPlugin_ports_0_entryToReplace_value == (2'b10));
  assign _zz_372_ = (MmuPlugin_ports_0_entryToReplace_value == (2'b11));
  assign _zz_373_ = (MmuPlugin_ports_1_entryToReplace_value == (2'b00));
  assign _zz_374_ = (MmuPlugin_ports_1_entryToReplace_value == (2'b01));
  assign _zz_375_ = (MmuPlugin_ports_1_entryToReplace_value == (2'b10));
  assign _zz_376_ = (MmuPlugin_ports_1_entryToReplace_value == (2'b11));
  assign _zz_377_ = {_zz_127_[1 : 0],_zz_127_[15 : 13]};
  assign _zz_378_ = _zz_127_[6 : 5];
  assign _zz_379_ = _zz_127_[11 : 10];
  assign _zz_380_ = writeBack_INSTRUCTION[13 : 12];
  assign _zz_381_ = writeBack_INSTRUCTION[13 : 12];
  assign _zz_382_ = execute_INSTRUCTION[13];
  assign _zz_383_ = (_zz_108_ - (5'b00001));
  assign _zz_384_ = {IBusCachedPlugin_fetchPc_inc,(2'b00)};
  assign _zz_385_ = {29'd0, _zz_384_};
  assign _zz_386_ = (decode_IS_RVC ? (3'b010) : (3'b100));
  assign _zz_387_ = {29'd0, _zz_386_};
  assign _zz_388_ = {{_zz_137_,_zz_127_[6 : 2]},(12'b000000000000)};
  assign _zz_389_ = {{{(4'b0000),_zz_127_[8 : 7]},_zz_127_[12 : 9]},(2'b00)};
  assign _zz_390_ = {{{(4'b0000),_zz_127_[8 : 7]},_zz_127_[12 : 9]},(2'b00)};
  assign _zz_391_ = (decode_IS_RVC ? (3'b010) : (3'b100));
  assign _zz_392_ = {29'd0, _zz_391_};
  assign _zz_393_ = {{{decode_INSTRUCTION[31],decode_INSTRUCTION[7]},decode_INSTRUCTION[30 : 25]},decode_INSTRUCTION[11 : 8]};
  assign _zz_394_ = {{_zz_155_,{{{decode_INSTRUCTION[31],decode_INSTRUCTION[7]},decode_INSTRUCTION[30 : 25]},decode_INSTRUCTION[11 : 8]}},1'b0};
  assign _zz_395_ = {{{decode_INSTRUCTION[31],decode_INSTRUCTION[19 : 12]},decode_INSTRUCTION[20]},decode_INSTRUCTION[30 : 21]};
  assign _zz_396_ = {{{decode_INSTRUCTION[31],decode_INSTRUCTION[7]},decode_INSTRUCTION[30 : 25]},decode_INSTRUCTION[11 : 8]};
  assign _zz_397_ = (writeBack_MEMORY_WR ? (3'b111) : (3'b101));
  assign _zz_398_ = (writeBack_MEMORY_WR ? (3'b110) : (3'b100));
  assign _zz_399_ = _zz_181_[0 : 0];
  assign _zz_400_ = _zz_181_[1 : 1];
  assign _zz_401_ = _zz_181_[3 : 3];
  assign _zz_402_ = _zz_181_[4 : 4];
  assign _zz_403_ = _zz_181_[7 : 7];
  assign _zz_404_ = _zz_181_[8 : 8];
  assign _zz_405_ = _zz_181_[13 : 13];
  assign _zz_406_ = _zz_181_[14 : 14];
  assign _zz_407_ = _zz_181_[15 : 15];
  assign _zz_408_ = _zz_181_[16 : 16];
  assign _zz_409_ = _zz_181_[17 : 17];
  assign _zz_410_ = _zz_181_[18 : 18];
  assign _zz_411_ = _zz_181_[21 : 21];
  assign _zz_412_ = _zz_181_[22 : 22];
  assign _zz_413_ = _zz_181_[23 : 23];
  assign _zz_414_ = _zz_181_[24 : 24];
  assign _zz_415_ = _zz_181_[25 : 25];
  assign _zz_416_ = _zz_181_[28 : 28];
  assign _zz_417_ = _zz_181_[31 : 31];
  assign _zz_418_ = _zz_181_[34 : 34];
  assign _zz_419_ = _zz_181_[35 : 35];
  assign _zz_420_ = execute_SRC_LESS;
  assign _zz_421_ = (execute_IS_RVC ? (3'b010) : (3'b100));
  ...
  assign _zz_425_ = ($signed(_zz_426_) + $signed(_zz_429_));
  ...
  assign _zz_429_ = (execute_SRC_USE_SUB_LESS ? _zz_430_ : _zz_431_);
  assign _zz_430_ = (32'b00000000000000000000000000000001);
  assign _zz_431_ = (32'b00000000000000000000000000000000);
  ...
  assign _zz_451_ = {_zz_217_,(! _zz_219_[32])};
  assign _zz_452_ = _zz_219_[31:0];
  assign _zz_453_ = _zz_218_[31:0];
  assign _zz_454_ = _zz_455_;
  assign _zz_455_ = _zz_456_;
  assign _zz_456_ = ({1'b0,(memory_DivPlugin_div_needRevert ? (~ _zz_220_) : _zz_220_)} + _zz_458_);
  assign _zz_457_ = memory_DivPlugin_div_needRevert;
  assign _zz_458_ = {32'd0, _zz_457_};
  assign _zz_459_ = _zz_222_;
  assign _zz_460_ = {32'd0, _zz_459_};
  assign _zz_461_ = _zz_221_;
  assign _zz_462_ = {31'd0, _zz_461_};
  assign _zz_463_ = (_zz_231_ & (~ _zz_464_));
  assign _zz_464_ = (_zz_231_ - (2'b01));
  assign _zz_465_ = execute_INSTRUCTION[31 : 20];
  assign _zz_466_ = {{{execute_INSTRUCTION[31],execute_INSTRUCTION[19 : 12]},execute_INSTRUCTION[20]},execute_INSTRUCTION[30 : 21]};
  assign _zz_467_ = {{{execute_INSTRUCTION[31],execute_INSTRUCTION[7]},execute_INSTRUCTION[30 : 25]},execute_INSTRUCTION[11 : 8]};
  assign _zz_468_ = (execute_IS_RVC ? (3'b010) : (3'b100));
  assign _zz_469_ = MmuPlugin_ports_0_entryToReplace_willIncrement;
  assign _zz_470_ = {1'd0, _zz_469_};
  assign _zz_471_ = MmuPlugin_ports_1_entryToReplace_willIncrement;
  assign _zz_472_ = {1'd0, _zz_471_};
  assign _zz_473_ = MmuPlugin_dBusAccess_rsp_payload_data[0 : 0];
  assign _zz_474_ = MmuPlugin_dBusAccess_rsp_payload_data[1 : 1];
  assign _zz_475_ = MmuPlugin_dBusAccess_rsp_payload_data[2 : 2];
  assign _zz_476_ = MmuPlugin_dBusAccess_rsp_payload_data[3 : 3];
  assign _zz_477_ = MmuPlugin_dBusAccess_rsp_payload_data[4 : 4];
  assign _zz_478_ = MmuPlugin_dBusAccess_rsp_payload_data[5 : 5];
  assign _zz_479_ = MmuPlugin_dBusAccess_rsp_payload_data[6 : 6];
  assign _zz_480_ = MmuPlugin_dBusAccess_rsp_payload_data[7 : 7];
  assign _zz_481_ = debug_bus_cmd_payload_data[0 : 0];
  assign _zz_482_ = debug_bus_cmd_payload_data[0 : 0];
  assign _zz_483_ = debug_bus_cmd_payload_data[0 : 0];
  assign _zz_484_ = debug_bus_cmd_payload_data[0 : 0];
  assign _zz_485_ = (decode_PC >>> 1);
  assign _zz_486_ = (decode_PC >>> 1);
  assign _zz_487_ = (decode_PC >>> 1);
  assign _zz_488_ = (decode_PC >>> 1);
  assign _zz_489_ = execute_CsrPlugin_writeData[7 : 7];
  assign _zz_490_ = execute_CsrPlugin_writeData[3 : 3];
  assign _zz_491_ = execute_CsrPlugin_writeData[5 : 5];
  assign _zz_492_ = execute_CsrPlugin_writeData[1 : 1];
  assign _zz_493_ = execute_CsrPlugin_writeData[19 : 19];
  assign _zz_494_ = execute_CsrPlugin_writeData[18 : 18];
  assign _zz_495_ = execute_CsrPlugin_writeData[17 : 17];
  ...
  assign _zz_499_ = execute_CsrPlugin_writeData[31 : 31];
  assign _zz_500_ = execute_CsrPlugin_writeData[5 : 5];
  assign _zz_501_ = execute_CsrPlugin_writeData[1 : 1];
  assign _zz_502_ = execute_CsrPlugin_writeData[19 : 19];
  assign _zz_503_ = execute_CsrPlugin_writeData[18 : 18];
  assign _zz_504_ = execute_CsrPlugin_writeData[17 : 17];
  assign _zz_505_ = execute_CsrPlugin_writeData[8 : 8];
  assign _zz_506_ = execute_CsrPlugin_writeData[2 : 2];
  assign _zz_507_ = execute_CsrPlugin_writeData[5 : 5];
  assign _zz_508_ = execute_CsrPlugin_writeData[13 : 13];
  assign _zz_509_ = execute_CsrPlugin_writeData[4 : 4];
  assign _zz_510_ = execute_CsrPlugin_writeData[7 : 7];
  assign _zz_511_ = execute_CsrPlugin_writeData[1 : 1];
  assign _zz_512_ = execute_CsrPlugin_writeData[9 : 9];
  assign _zz_513_ = execute_CsrPlugin_writeData[12 : 12];
  assign _zz_514_ = execute_CsrPlugin_writeData[15 : 15];
  assign _zz_515_ = execute_CsrPlugin_writeData[6 : 6];
  assign _zz_516_ = execute_CsrPlugin_writeData[0 : 0];
  assign _zz_517_ = execute_CsrPlugin_writeData[3 : 3];
  ...
  assign _zz_521_ = execute_CsrPlugin_writeData[31 : 31];
  ...
  assign _zz_525_ = execute_CsrPlugin_writeData[11 : 11];
  assign _zz_526_ = execute_CsrPlugin_writeData[7 : 7];
  assign _zz_527_ = execute_CsrPlugin_writeData[3 : 3];
  ...
  assign _zz_531_ = execute_CsrPlugin_writeData[9 : 9];
  assign _zz_532_ = execute_CsrPlugin_writeData[5 : 5];
  assign _zz_533_ = execute_CsrPlugin_writeData[1 : 1];
  assign _zz_534_ = (iBus_cmd_payload_address >>> 5);
  assign _zz_535_ = {_zz_111_,{_zz_113_,_zz_112_}};
  assign _zz_536_ = (_zz_127_[11 : 10] == (2'b01));
  assign _zz_537_ = ((_zz_127_[11 : 10] == (2'b11)) && (_zz_127_[6 : 5] == (2'b00)));
  assign _zz_538_ = (7'b0000000);
  assign _zz_539_ = _zz_127_[6 : 2];
  assign _zz_540_ = _zz_127_[12];
  assign _zz_541_ = _zz_127_[11 : 7];
  assign _zz_542_ = decode_INSTRUCTION[31];
  assign _zz_543_ = decode_INSTRUCTION[19 : 12];
  assign _zz_544_ = decode_INSTRUCTION[20];
  assign _zz_545_ = decode_INSTRUCTION[31];
  assign _zz_546_ = decode_INSTRUCTION[7];
  assign _zz_547_ = (32'b00000000000000000101000001001000);
  assign _zz_548_ = ((decode_INSTRUCTION & _zz_556_) == (32'b00000000000000000010000000010000));
  assign _zz_549_ = {(_zz_557_ == _zz_558_),{_zz_559_,_zz_560_}};
  assign _zz_550_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000000000)) == (32'b00000000000000000001000000000000));
  assign _zz_551_ = ((decode_INSTRUCTION & _zz_561_) == (32'b00000000000000000010000000000000));
  assign _zz_552_ = (1'b0);
  assign _zz_553_ = (_zz_186_ != (1'b0));
  assign _zz_554_ = ({_zz_562_,_zz_563_} != (3'b000));
  assign _zz_555_ = {(_zz_564_ != _zz_565_),{_zz_566_,{_zz_567_,_zz_568_}}};
  assign _zz_556_ = (32'b00000000000000000010000000110000);
  assign _zz_557_ = (decode_INSTRUCTION & (32'b00000000000000000001000000110000));
  assign _zz_558_ = (32'b00000000000000000000000000010000);
  assign _zz_559_ = ((decode_INSTRUCTION & (32'b00000010000000000011000000100000)) == (32'b00000000000000000000000000100000));
  assign _zz_560_ = ((decode_INSTRUCTION & (32'b00000010000000000010000001101000)) == (32'b00000000000000000010000000100000));
  assign _zz_561_ = (32'b00000000000000000011000000000000);
  assign _zz_562_ = _zz_183_;
  assign _zz_563_ = {_zz_187_,(_zz_569_ == _zz_570_)};
  assign _zz_564_ = {_zz_187_,(_zz_571_ == _zz_572_)};
  assign _zz_565_ = (2'b00);
  assign _zz_566_ = ((_zz_573_ == _zz_574_) != (1'b0));
  assign _zz_567_ = ({_zz_575_,_zz_576_} != (2'b00));
  assign _zz_568_ = {(_zz_577_ != _zz_578_),{_zz_579_,{_zz_580_,_zz_581_}}};
  assign _zz_569_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010100));
  ...
  assign _zz_575_ = ((decode_INSTRUCTION & _zz_582_) == (32'b00000000000000000101000000010000));
  assign _zz_576_ = ((decode_INSTRUCTION & _zz_583_) == (32'b00000000000000000101000000100000));
  assign _zz_577_ = {(_zz_584_ == _zz_585_),{_zz_586_,_zz_587_}};
  assign _zz_578_ = (3'b000);
  assign _zz_579_ = ((_zz_588_ == _zz_589_) != (1'b0));
  assign _zz_580_ = (_zz_590_ != (1'b0));
  assign _zz_581_ = {(_zz_591_ != _zz_592_),{_zz_593_,{_zz_594_,_zz_595_}}};
  assign _zz_582_ = (32'b00000000000000000111000000110100);
  assign _zz_583_ = (32'b00000010000000000111000001100100);
  assign _zz_584_ = (decode_INSTRUCTION & (32'b01000000000000000011000001010100));
  assign _zz_585_ = (32'b01000000000000000001000000010000);
  assign _zz_586_ = ((decode_INSTRUCTION & (32'b00000000000000000111000000110100)) == (32'b00000000000000000001000000010000));
  assign _zz_587_ = ((decode_INSTRUCTION & (32'b00000010000000000111000001010100)) == (32'b00000000000000000001000000010000));
  assign _zz_588_ = (decode_INSTRUCTION & (32'b00010000000000000000000000001000));
  assign _zz_589_ = (32'b00000000000000000000000000001000);
  assign _zz_590_ = ((decode_INSTRUCTION & (32'b00010000000100000011000001010000)) == (32'b00000000000100000000000001010000));
  assign _zz_591_ = {(_zz_596_ == _zz_597_),{_zz_598_,{_zz_599_,_zz_600_}}};
  assign _zz_592_ = (5'b00000);
  assign _zz_593_ = ((_zz_601_ == _zz_602_) != (1'b0));
  assign _zz_594_ = ({_zz_603_,_zz_604_} != (3'b000));
  assign _zz_595_ = {(_zz_605_ != _zz_606_),{_zz_607_,{_zz_608_,_zz_609_}}};
  assign _zz_596_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000000));
  assign _zz_597_ = (32'b00000000000000000000000001000000);
  assign _zz_598_ = ((decode_INSTRUCTION & _zz_610_) == (32'b00000000000000000100000000100000));
  assign _zz_599_ = (_zz_611_ == _zz_612_);
  assign _zz_600_ = {_zz_182_,_zz_613_};
  assign _zz_601_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_602_ = (32'b00000000000000000000000000100100);
  assign _zz_603_ = (_zz_614_ == _zz_615_);
  assign _zz_604_ = {_zz_616_,_zz_617_};
  assign _zz_605_ = (_zz_618_ == _zz_619_);
  assign _zz_606_ = (1'b0);
  assign _zz_607_ = (_zz_620_ != (1'b0));
  assign _zz_608_ = (_zz_621_ != _zz_622_);
  assign _zz_609_ = {_zz_623_,{_zz_624_,_zz_625_}};
  assign _zz_610_ = (32'b00000000000000000100000000100000);
  assign _zz_611_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110000));
  assign _zz_612_ = (32'b00000000000000000000000000010000);
  assign _zz_613_ = ((decode_INSTRUCTION & (32'b00000010000000000000000000101000)) == (32'b00000000000000000000000000100000));
  assign _zz_614_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_615_ = (32'b00000000000000000000000001000000);
  assign _zz_616_ = ((decode_INSTRUCTION & (32'b00000000000000000010000000010100)) == (32'b00000000000000000010000000010000));
  assign _zz_617_ = ((decode_INSTRUCTION & (32'b01000000000000000000000000110100)) == (32'b01000000000000000000000000110000));
  assign _zz_618_ = (decode_INSTRUCTION & (32'b00000000000000000100000000010100));
  assign _zz_619_ = (32'b00000000000000000100000000010000);
  assign _zz_620_ = ((decode_INSTRUCTION & (32'b00000000000000000110000000010100)) == (32'b00000000000000000010000000010000));
  assign _zz_621_ = {(_zz_626_ == _zz_627_),{_zz_628_,{_zz_629_,_zz_630_}}};
  assign _zz_622_ = (4'b0000);
  assign _zz_623_ = ((_zz_631_ == _zz_632_) != (1'b0));
  assign _zz_624_ = ({_zz_633_,_zz_634_} != (3'b000));
  assign _zz_625_ = {(_zz_635_ != _zz_636_),{_zz_637_,{_zz_638_,_zz_639_}}};
  assign _zz_626_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110100));
  assign _zz_627_ = (32'b00000000000000000000000000100000);
  assign _zz_628_ = ((decode_INSTRUCTION & _zz_640_) == (32'b00000000000000000000000000100000));
  assign _zz_629_ = (_zz_641_ == _zz_642_);
  assign _zz_630_ = (_zz_643_ == _zz_644_);
  assign _zz_631_ = (decode_INSTRUCTION & (32'b00000000000000000100000001001000));
  assign _zz_632_ = (32'b00000000000000000100000000001000);
  assign _zz_633_ = (_zz_645_ == _zz_646_);
  assign _zz_634_ = {_zz_647_,_zz_648_};
  assign _zz_635_ = (_zz_649_ == _zz_650_);
  assign _zz_636_ = (1'b0);
  assign _zz_637_ = ({_zz_651_,_zz_652_} != (2'b00));
  assign _zz_638_ = (_zz_653_ != _zz_654_);
  assign _zz_639_ = {_zz_655_,{_zz_656_,_zz_657_}};
  assign _zz_640_ = (32'b00000000000000000000000001100100);
  assign _zz_641_ = (decode_INSTRUCTION & (32'b00001000000000000000000001110000));
  assign _zz_642_ = (32'b00001000000000000000000000100000);
  assign _zz_643_ = (decode_INSTRUCTION & (32'b00010000000000000000000001110000));
  assign _zz_644_ = (32'b00000000000000000000000000100000);
  assign _zz_645_ = (decode_INSTRUCTION & (32'b00001000000000000000000000100000));
  assign _zz_646_ = (32'b00001000000000000000000000100000);
  assign _zz_647_ = ((decode_INSTRUCTION & (32'b00010000000000000000000000100000)) == (32'b00000000000000000000000000100000));
  assign _zz_648_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000101000)) == (32'b00000000000000000000000000100000));
  assign _zz_649_ = (decode_INSTRUCTION & (32'b00000010000000000100000001100100));
  assign _zz_650_ = (32'b00000010000000000100000000100000);
  assign _zz_651_ = _zz_184_;
  assign _zz_652_ = ((decode_INSTRUCTION & _zz_658_) == (32'b00000000000000000000000000000000));
  assign _zz_653_ = ((decode_INSTRUCTION & _zz_659_) == (32'b00010000000000000000000000001000));
  assign _zz_654_ = (1'b0);
  assign _zz_655_ = ({_zz_183_,_zz_660_} != (2'b00));
  assign _zz_656_ = (_zz_661_ != (1'b0));
  assign _zz_657_ = {(_zz_662_ != _zz_663_),{_zz_664_,{_zz_665_,_zz_666_}}};
  assign _zz_658_ = (32'b00000000000000000000000001011000);
  assign _zz_659_ = (32'b00010000000000000000000000001000);
  assign _zz_660_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000011100)) == (32'b00000000000000000000000000000100));
  assign _zz_661_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001011000)) == (32'b00000000000000000000000001000000));
  assign _zz_662_ = {(_zz_667_ == _zz_668_),(_zz_669_ == _zz_670_)};
  assign _zz_663_ = (2'b00);
  assign _zz_664_ = ((_zz_671_ == _zz_672_) != (1'b0));
  assign _zz_665_ = (_zz_186_ != (1'b0));
  assign _zz_666_ = {(_zz_673_ != _zz_674_),{_zz_675_,{_zz_676_,_zz_677_}}};
  assign _zz_667_ = (decode_INSTRUCTION & (32'b00010000000100000011000001010000));
  assign _zz_668_ = (32'b00000000000000000000000001010000);
  assign _zz_669_ = (decode_INSTRUCTION & (32'b00010010001000000011000001010000));
  assign _zz_670_ = (32'b00010000000000000000000001010000);
  assign _zz_671_ = (decode_INSTRUCTION & (32'b00000010000100000011000001010000));
  assign _zz_672_ = (32'b00000000000000000000000001010000);
  assign _zz_673_ = {(_zz_678_ == _zz_679_),(_zz_680_ == _zz_681_)};
  assign _zz_674_ = (2'b00);
  assign _zz_675_ = ({_zz_185_,_zz_682_} != (2'b00));
  assign _zz_676_ = ({_zz_683_,_zz_684_} != (2'b00));
  assign _zz_677_ = {(_zz_685_ != _zz_686_),{_zz_687_,{_zz_688_,_zz_689_}}};
  assign _zz_678_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010000));
  assign _zz_679_ = (32'b00000000000000000010000000000000);
  assign _zz_680_ = (decode_INSTRUCTION & (32'b00000000000000000101000000000000));
  assign _zz_681_ = (32'b00000000000000000001000000000000);
  assign _zz_682_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001110000)) == (32'b00000000000000000000000000100000));
  assign _zz_683_ = _zz_185_;
  assign _zz_684_ = ((decode_INSTRUCTION & _zz_690_) == (32'b00000000000000000000000000000000));
  assign _zz_685_ = {(_zz_691_ == _zz_692_),{_zz_693_,{_zz_694_,_zz_695_}}};
  assign _zz_686_ = (5'b00000);
  assign _zz_687_ = ({_zz_696_,_zz_697_} != (2'b00));
  assign _zz_688_ = ({_zz_698_,_zz_699_} != (6'b000000));
  assign _zz_689_ = {(_zz_700_ != _zz_701_),(_zz_702_ != _zz_703_)};
  assign _zz_690_ = (32'b00000000000000000000000000100000);
  assign _zz_691_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_692_ = (32'b00000000000000000000000000000000);
  assign _zz_693_ = ((decode_INSTRUCTION & _zz_704_) == (32'b00000000000000000000000000000000));
  assign _zz_694_ = (_zz_705_ == _zz_706_);
  assign _zz_695_ = {_zz_707_,_zz_184_};
  assign _zz_696_ = ((decode_INSTRUCTION & _zz_708_) == (32'b00000000000000000001000001010000));
  assign _zz_697_ = ((decode_INSTRUCTION & _zz_709_) == (32'b00000000000000000010000001010000));
  assign _zz_698_ = (_zz_710_ == _zz_711_);
  assign _zz_699_ = {_zz_712_,{_zz_713_,_zz_714_}};
  assign _zz_700_ = {_zz_183_,{_zz_715_,_zz_716_}};
  assign _zz_701_ = (7'b0000000);
  assign _zz_702_ = (_zz_717_ == _zz_718_);
  assign _zz_703_ = (1'b0);
  assign _zz_704_ = (32'b00000000000000000000000000011000);
  assign _zz_705_ = (decode_INSTRUCTION & (32'b00000000000000000110000000000100));
  assign _zz_706_ = (32'b00000000000000000010000000000000);
  assign _zz_707_ = ((decode_INSTRUCTION & (32'b00000000000000000101000000000100)) == (32'b00000000000000000001000000000000));
  assign _zz_708_ = (32'b00000000000000000001000001010000);
  assign _zz_709_ = (32'b00000000000000000010000001010000);
  assign _zz_710_ = (decode_INSTRUCTION & (32'b00000000000000000010000001000000));
  assign _zz_711_ = (32'b00000000000000000010000001000000);
  assign _zz_712_ = ((decode_INSTRUCTION & (32'b00000000000000000001000001000000)) == (32'b00000000000000000001000001000000));
  assign _zz_713_ = ((decode_INSTRUCTION & _zz_719_) == (32'b00000000000000000000000001000000));
  assign _zz_714_ = {(_zz_720_ == _zz_721_),{_zz_722_,_zz_723_}};
  assign _zz_715_ = ((decode_INSTRUCTION & _zz_724_) == (32'b00000000000000000001000000010000));
  assign _zz_716_ = {(_zz_725_ == _zz_726_),{_zz_727_,{_zz_728_,_zz_729_}}};
  assign _zz_717_ = (decode_INSTRUCTION & (32'b00000010000000000011000001010000));
  assign _zz_718_ = (32'b00000010000000000000000001010000);
  assign _zz_719_ = (32'b00000000000000000000000001010000);
  assign _zz_720_ = (decode_INSTRUCTION & (32'b00000010000100000000000001000000));
  assign _zz_721_ = (32'b00000000000000000000000001000000);
  assign _zz_722_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000111000)) == (32'b00000000000000000000000000000000));
  assign _zz_723_ = ((decode_INSTRUCTION & (32'b00011000000000000010000000001000)) == (32'b00010000000000000010000000001000));
  assign _zz_724_ = (32'b00000000000000000001000000010000);
  assign _zz_725_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010000));
  assign _zz_726_ = (32'b00000000000000000010000000010000);
  assign _zz_727_ = ((decode_INSTRUCTION & (32'b00000000000000000010000000001000)) == (32'b00000000000000000010000000001000));
  assign _zz_728_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001010000)) == (32'b00000000000000000000000000010000));
  assign _zz_729_ = {_zz_182_,((decode_INSTRUCTION & (32'b00000000000000000000000000101000)) == (32'b00000000000000000000000000000000))};
  assign _zz_730_ = (32'b00000000000000000001000001111111);
  assign _zz_731_ = (decode_INSTRUCTION & (32'b00000000000000000010000001111111));
  assign _zz_732_ = (32'b00000000000000000010000001110011);
  assign _zz_733_ = ((decode_INSTRUCTION & (32'b00000000000000000100000001111111)) == (32'b00000000000000000100000001100011));
  assign _zz_734_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001111111)) == (32'b00000000000000000010000000010011));
  assign _zz_735_ = {((decode_INSTRUCTION & (32'b00000000000000000110000000111111)) == (32'b00000000000000000000000000100011)),{((decode_INSTRUCTION & (32'b00000000000000000010000001111111)) == (32'b00000000000000000000000000000011)),{((decode_INSTRUCTION & _zz_736_) == (32'b00000000000000000000000000000011)),{(_zz_737_ == _zz_738_),{_zz_739_,{_zz_740_,_zz_741_}}}}}};
  assign _zz_736_ = (32'b00000000000000000101000001011111);
  assign _zz_737_ = (decode_INSTRUCTION & (32'b00000000000000000111000001111011));
  assign _zz_738_ = (32'b00000000000000000000000001100011);
  assign _zz_739_ = ((decode_INSTRUCTION & (32'b00000000000000000110000001111111)) == (32'b00000000000000000000000000001111));
  assign _zz_740_ = ((decode_INSTRUCTION & (32'b00011000000000000111000001111111)) == (32'b00000000000000000010000000101111));
  assign _zz_741_ = {((decode_INSTRUCTION & (32'b11111100000000000000000001111111)) == (32'b00000000000000000000000000110011)),{((decode_INSTRUCTION & (32'b11101000000000000111000001111111)) == (32'b00001000000000000010000000101111)),{((decode_INSTRUCTION & _zz_742_) == (32'b00000000000000000101000000001111)),{(_zz_743_ == _zz_744_),{_zz_745_,{_zz_746_,_zz_747_}}}}}};
  assign _zz_742_ = (32'b00000001111100000111000001111111);
  assign _zz_743_ = (decode_INSTRUCTION & (32'b10111100000000000111000001111111));
  assign _zz_744_ = (32'b00000000000000000101000000010011);
  assign _zz_745_ = ((decode_INSTRUCTION & (32'b11111100000000000011000001111111)) == (32'b00000000000000000001000000010011));
  assign _zz_746_ = ((decode_INSTRUCTION & (32'b10111110000000000111000001111111)) == (32'b00000000000000000101000000110011));
  assign _zz_747_ = {((decode_INSTRUCTION & (32'b10111110000000000111000001111111)) == (32'b00000000000000000000000000110011)),{((decode_INSTRUCTION & (32'b11111001111100000111000001111111)) == (32'b00010000000000000010000000101111)),{((decode_INSTRUCTION & _zz_748_) == (32'b00010010000000000000000001110011)),{(_zz_749_ == _zz_750_),{_zz_751_,_zz_752_}}}}};
  assign _zz_748_ = (32'b11111110000000000111111111111111);
  assign _zz_749_ = (decode_INSTRUCTION & (32'b11011111111111111111111111111111));
  assign _zz_750_ = (32'b00010000001000000000000001110011);
  assign _zz_751_ = ((decode_INSTRUCTION & (32'b11111111111011111111111111111111)) == (32'b00000000000000000000000001110011));
  assign _zz_752_ = ((decode_INSTRUCTION & (32'b11111111111111111111111111111111)) == (32'b00010000010100000000000001110011));
  assign _zz_753_ = execute_INSTRUCTION[31];
  assign _zz_754_ = execute_INSTRUCTION[31];
  assign _zz_755_ = execute_INSTRUCTION[7];
  always @ (posedge clk) begin
    if(_zz_62_) begin
  ...
  always @(*) begin
    case(_zz_88_)
      `Src2CtrlEnum_defaultEncoding_RS : _zz_88__string = "RS ";
      `Src2CtrlEnum_defaultEncoding_IMI : _zz_88__string = "IMI";
      `Src2CtrlEnum_defaultEncoding_IMS : _zz_88__string = "IMS";
      `Src2CtrlEnum_defaultEncoding_PC : _zz_88__string = "PC ";
  ...
  always @(*) begin
    case(_zz_188_)
      `Src2CtrlEnum_defaultEncoding_RS : _zz_188__string = "RS ";
      `Src2CtrlEnum_defaultEncoding_IMI : _zz_188__string = "IMI";
      `Src2CtrlEnum_defaultEncoding_IMS : _zz_188__string = "IMS";
      `Src2CtrlEnum_defaultEncoding_PC : _zz_188__string = "PC ";
      default : _zz_188__string = "???";
    endcase
  end
  always @(*) begin
    case(_zz_189_)
      `EnvCtrlEnum_defaultEncoding_NONE : _zz_189__string = "NONE ";
      `EnvCtrlEnum_defaultEncoding_XRET : _zz_189__string = "XRET ";
      `EnvCtrlEnum_defaultEncoding_WFI : _zz_189__string = "WFI  ";
      `EnvCtrlEnum_defaultEncoding_ECALL : _zz_189__string = "ECALL";
      default : _zz_189__string = "?????";
    endcase
  end
  always @(*) begin
    case(_zz_190_)
      `BranchCtrlEnum_defaultEncoding_INC : _zz_190__string = "INC ";
      `BranchCtrlEnum_defaultEncoding_B : _zz_190__string = "B   ";
      `BranchCtrlEnum_defaultEncoding_JAL : _zz_190__string = "JAL ";
      `BranchCtrlEnum_defaultEncoding_JALR : _zz_190__string = "JALR";
      default : _zz_190__string = "????";
    endcase
  end
  always @(*) begin
    case(_zz_191_)
      `AluCtrlEnum_defaultEncoding_ADD_SUB : _zz_191__string = "ADD_SUB ";
      `AluCtrlEnum_defaultEncoding_SLT_SLTU : _zz_191__string = "SLT_SLTU";
      `AluCtrlEnum_defaultEncoding_BITWISE : _zz_191__string = "BITWISE ";
      default : _zz_191__string = "????????";
    endcase
  end
  always @(*) begin
    case(_zz_192_)
      `ShiftCtrlEnum_defaultEncoding_DISABLE_1 : _zz_192__string = "DISABLE_1";
      `ShiftCtrlEnum_defaultEncoding_SLL_1 : _zz_192__string = "SLL_1    ";
      `ShiftCtrlEnum_defaultEncoding_SRL_1 : _zz_192__string = "SRL_1    ";
      `ShiftCtrlEnum_defaultEncoding_SRA_1 : _zz_192__string = "SRA_1    ";
      default : _zz_192__string = "?????????";
    endcase
  end
  always @(*) begin
    case(_zz_193_)
      `Src1CtrlEnum_defaultEncoding_RS : _zz_193__string = "RS          ";
      `Src1CtrlEnum_defaultEncoding_IMU : _zz_193__string = "IMU         ";
      `Src1CtrlEnum_defaultEncoding_PC_INCREMENT : _zz_193__string = "PC_INCREMENT";
      `Src1CtrlEnum_defaultEncoding_URS1 : _zz_193__string = "URS1        ";
      default : _zz_193__string = "????????????";
    endcase
  end
  always @(*) begin
    case(_zz_194_)
      `AluBitwiseCtrlEnum_defaultEncoding_XOR_1 : _zz_194__string = "XOR_1";
      `AluBitwiseCtrlEnum_defaultEncoding_OR_1 : _zz_194__string = "OR_1 ";
      `AluBitwiseCtrlEnum_defaultEncoding_AND_1 : _zz_194__string = "AND_1";
  ...
  assign decode_IS_SFENCE_VMA = _zz_92_;
  ...
  always @ (*) begin
    decode_RS2 = _zz_63_;
    if(_zz_208_)begin
      if((_zz_209_ == decode_INSTRUCTION[24 : 20]))begin
        decode_RS2 = _zz_210_;
      end
    end
    if(_zz_316_)begin
  ...
  always @ (*) begin
    decode_RS1 = _zz_64_;
    if(_zz_208_)begin
      if((_zz_209_ == decode_INSTRUCTION[19 : 15]))begin
        decode_RS1 = _zz_210_;
      end
    end
    if(_zz_316_)begin
  ...
  always @ (*) begin
    decode_REGFILE_WRITE_VALID = _zz_91_;
  ...
  assign decode_MEMORY_ENABLE = _zz_82_;
  ...
  assign decode_BRANCH_CTRL = _zz_100_;
  always @ (*) begin
    decode_INSTRUCTION = _zz_105_;
    if((_zz_254_ != (3'b000)))begin
      decode_INSTRUCTION = IBusCachedPlugin_injectionPort_payload_regNext;
    end
  end

  always @ (*) begin
    _zz_101_ = memory_FORMAL_PC_NEXT;
  ...
  always @ (*) begin
    ...
    if(IBusCachedPlugin_predictionJumpInterface_valid)begin
      _zz_102_ = IBusCachedPlugin_predictionJumpInterface_payload;
    end
  ...
  always @ (*) begin
    ...
    if((decode_arbitration_isValid && (_zz_205_ || _zz_206_)))begin
      decode_arbitration_haltByOther = 1'b1;
    end
  ...
  assign _zz_109_ = (_zz_108_ & (~ _zz_383_));
  ...
  always @ (*) begin
    IBusCachedPlugin_fetchPc_pc = (IBusCachedPlugin_fetchPc_pcReg + _zz_385_);
  ...
  assign IBusCachedPlugin_decodePc_pcPlus = (IBusCachedPlugin_decodePc_pcReg + _zz_387_);
  always @ (*) begin
  ...
  assign IBusCachedPlugin_iBusRsp_stages_2_output_ready = ((1'b0 && (! _zz_124_)) || IBusCachedPlugin_iBusRsp_cacheRspArbitration_input_ready);
  ...
  assign _zz_127_ = IBusCachedPlugin_decompressor_rawInDecode[15 : 0];
  always @ (*) begin
    IBusCachedPlugin_decompressor_decompressed = (32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx);
    case(_zz_377_)
      5'b00000 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{{{{{{(2'b00),_zz_127_[10 : 7]},_zz_127_[12 : 11]},_zz_127_[5]},_zz_127_[6]},(2'b00)},(5'b00010)},(3'b000)},_zz_129_},(7'b0010011)};
      end
      5'b00010 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{_zz_130_,_zz_128_},(3'b010)},_zz_129_},(7'b0000011)};
      end
      5'b00110 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{{_zz_130_[11 : 5],_zz_129_},_zz_128_},(3'b010)},_zz_130_[4 : 0]},(7'b0100011)};
      end
      5'b01000 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{_zz_132_,_zz_127_[11 : 7]},(3'b000)},_zz_127_[11 : 7]},(7'b0010011)};
      end
      5'b01001 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{{_zz_135_[20],_zz_135_[10 : 1]},_zz_135_[11]},_zz_135_[19 : 12]},_zz_147_},(7'b1101111)};
      end
      5'b01010 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{_zz_132_,(5'b00000)},(3'b000)},_zz_127_[11 : 7]},(7'b0010011)};
      end
      5'b01011 : begin
        IBusCachedPlugin_decompressor_decompressed = ((_zz_127_[11 : 7] == (5'b00010)) ? {{{{{{{{{_zz_139_,_zz_127_[4 : 3]},_zz_127_[5]},_zz_127_[2]},_zz_127_[6]},(4'b0000)},_zz_127_[11 : 7]},(3'b000)},_zz_127_[11 : 7]},(7'b0010011)} : {{_zz_388_[31 : 12],_zz_127_[11 : 7]},(7'b0110111)});
      end
      5'b01100 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{{((_zz_127_[11 : 10] == (2'b10)) ? _zz_153_ : {{(1'b0),(_zz_536_ || _zz_537_)},(5'b00000)}),(((! _zz_127_[11]) || _zz_149_) ? _zz_127_[6 : 2] : _zz_129_)},_zz_128_},_zz_151_},_zz_128_},(_zz_149_ ? (7'b0010011) : (7'b0110011))};
      end
      5'b01101 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{{_zz_142_[20],_zz_142_[10 : 1]},_zz_142_[11]},_zz_142_[19 : 12]},_zz_146_},(7'b1101111)};
      end
      5'b01110 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{{{{_zz_145_[12],_zz_145_[10 : 5]},_zz_146_},_zz_128_},(3'b000)},_zz_145_[4 : 1]},_zz_145_[11]},(7'b1100011)};
      end
      5'b01111 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{{{{_zz_145_[12],_zz_145_[10 : 5]},_zz_146_},_zz_128_},(3'b001)},_zz_145_[4 : 1]},_zz_145_[11]},(7'b1100011)};
      end
      5'b10000 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{{(7'b0000000),_zz_127_[6 : 2]},_zz_127_[11 : 7]},(3'b001)},_zz_127_[11 : 7]},(7'b0010011)};
      end
      5'b10010 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{{{{{(4'b0000),_zz_127_[3 : 2]},_zz_127_[12]},_zz_127_[6 : 4]},(2'b00)},_zz_148_},(3'b010)},_zz_127_[11 : 7]},(7'b0000011)};
      end
      5'b10100 : begin
        IBusCachedPlugin_decompressor_decompressed = ((_zz_127_[12 : 2] == (11'b10000000000)) ? (32'b00000000000100000000000001110011) : ((_zz_127_[6 : 2] == (5'b00000)) ? {{{{(12'b000000000000),_zz_127_[11 : 7]},(3'b000)},(_zz_127_[12] ? _zz_147_ : _zz_146_)},(7'b1100111)} : {{{{{_zz_538_,_zz_539_},(_zz_540_ ? _zz_541_ : _zz_146_)},(3'b000)},_zz_127_[11 : 7]},(7'b0110011)}));
      end
      5'b10110 : begin
        IBusCachedPlugin_decompressor_decompressed = {{{{{_zz_389_[11 : 5],_zz_127_[6 : 2]},_zz_148_},(3'b010)},_zz_390_[4 : 0]},(7'b0100011)};
      end
      default : begin
      end
    endcase
  ...
  assign _zz_128_ = {(2'b01),_zz_127_[9 : 7]};
  assign _zz_129_ = {(2'b01),_zz_127_[4 : 2]};
  assign _zz_130_ = {{{{(5'b00000),_zz_127_[5]},_zz_127_[12 : 10]},_zz_127_[6]},(2'b00)};
  assign _zz_131_ = _zz_127_[12];
  always @ (*) begin
    ...
    _zz_132_[6] = _zz_131_;
    _zz_132_[5] = _zz_131_;
    _zz_132_[4 : 0] = _zz_127_[6 : 2];
  end

  assign _zz_133_ = _zz_127_[12];
  always @ (*) begin
    _zz_134_[9] = _zz_133_;
    _zz_134_[8] = _zz_133_;
    _zz_134_[7] = _zz_133_;
  ...
  assign _zz_135_ = {{{{{{{{_zz_134_,_zz_127_[8]},_zz_127_[10 : 9]},_zz_127_[6]},_zz_127_[7]},_zz_127_[2]},_zz_127_[11]},_zz_127_[5 : 3]},(1'b0)};
  assign _zz_136_ = _zz_127_[12];
  always @ (*) begin
  ...
  assign _zz_142_ = {{{{{{{{_zz_141_,_zz_127_[8]},_zz_127_[10 : 9]},_zz_127_[6]},_zz_127_[7]},_zz_127_[2]},_zz_127_[11]},_zz_127_[5 : 3]},(1'b0)};
  assign _zz_143_ = _zz_127_[12];
  always @ (*) begin
    _zz_144_[4] = _zz_143_;
    _zz_144_[3] = _zz_143_;
    _zz_144_[2] = _zz_143_;
  ...
  assign _zz_145_ = {{{{{_zz_144_,_zz_127_[6 : 5]},_zz_127_[2]},_zz_127_[11 : 10]},_zz_127_[4 : 3]},(1'b0)};
  assign _zz_146_ = (5'b00000);
  assign _zz_147_ = (5'b00001);
  assign _zz_148_ = (5'b00010);
  assign _zz_149_ = (_zz_127_[11 : 10] != (2'b11));
  always @ (*) begin
    case(_zz_378_)
      2'b00 : begin
        _zz_150_ = (3'b000);
  ...
  assign _zz_106_ = IBusCachedPlugin_decodePc_pcReg;
  assign _zz_105_ = IBusCachedPlugin_decompressor_decodeInput_payload_rsp_inst;
  assign _zz_104_ = IBusCachedPlugin_decompressor_decodeInput_payload_isRvc;
  assign _zz_103_ = (decode_PC + _zz_392_);
  assign _zz_154_ = _zz_393_[11];
  always @ (*) begin
  ...
  assign IBusCachedPlugin_decodePrediction_cmd_hadBranch = ((decode_BRANCH_CTRL == `BranchCtrlEnum_defaultEncoding_JAL) || ((decode_BRANCH_CTRL == `BranchCtrlEnum_defaultEncoding_B) && _zz_394_[31]));
  assign IBusCachedPlugin_predictionJumpInterface_valid = (decode_arbitration_isValid && IBusCachedPlugin_decodePrediction_cmd_hadBranch);
  assign _zz_156_ = _zz_395_[19];
  always @ (*) begin
  ...
  assign IBusCachedPlugin_predictionJumpInterface_payload = (decode_PC + ((decode_BRANCH_CTRL == `BranchCtrlEnum_defaultEncoding_JAL) ? {{_zz_157_,{{{_zz_542_,_zz_543_},_zz_544_},decode_INSTRUCTION[30 : 21]}},1'b0} : {{_zz_159_,{{{_zz_545_,_zz_546_},decode_INSTRUCTION[30 : 25]},decode_INSTRUCTION[11 : 8]}},1'b0}));
  ...
  assign dataCache_1__io_mem_cmd_s2mPipe_valid = (dataCache_1__io_mem_cmd_valid || _zz_161_);
  assign _zz_289_ = (! _zz_161_);
  assign dataCache_1__io_mem_cmd_s2mPipe_payload_wr = (_zz_161_ ? _zz_162_ : dataCache_1__io_mem_cmd_payload_wr);
  assign dataCache_1__io_mem_cmd_s2mPipe_payload_address = (_zz_161_ ? _zz_163_ : dataCache_1__io_mem_cmd_payload_address);
  assign dataCache_1__io_mem_cmd_s2mPipe_payload_data = (_zz_161_ ? _zz_164_ : dataCache_1__io_mem_cmd_payload_data);
  assign dataCache_1__io_mem_cmd_s2mPipe_payload_mask = (_zz_161_ ? _zz_165_ : dataCache_1__io_mem_cmd_payload_mask);
  assign dataCache_1__io_mem_cmd_s2mPipe_payload_length = (_zz_161_ ? _zz_166_ : dataCache_1__io_mem_cmd_payload_length);
  assign dataCache_1__io_mem_cmd_s2mPipe_payload_last = (_zz_161_ ? _zz_167_ : dataCache_1__io_mem_cmd_payload_last);
  ...
  assign dataCache_1__io_mem_cmd_s2mPipe_m2sPipe_valid = _zz_168_;
  assign dataCache_1__io_mem_cmd_s2mPipe_m2sPipe_payload_wr = _zz_169_;
  assign dataCache_1__io_mem_cmd_s2mPipe_m2sPipe_payload_address = _zz_170_;
  assign dataCache_1__io_mem_cmd_s2mPipe_m2sPipe_payload_data = _zz_171_;
  assign dataCache_1__io_mem_cmd_s2mPipe_m2sPipe_payload_mask = _zz_172_;
  assign dataCache_1__io_mem_cmd_s2mPipe_m2sPipe_payload_length = _zz_173_;
  assign dataCache_1__io_mem_cmd_s2mPipe_m2sPipe_payload_last = _zz_174_;
  ...
  always @ (*) begin
    case(execute_DBusCachedPlugin_size)
      2'b00 : begin
        _zz_176_ = {{{execute_RS2[7 : 0],execute_RS2[7 : 0]},execute_RS2[7 : 0]},execute_RS2[7 : 0]};
      end
      2'b01 : begin
        _zz_176_ = {execute_RS2[15 : 0],execute_RS2[15 : 0]};
      end
      default : begin
        _zz_176_ = execute_RS2[31 : 0];
      end
    endcase
  end
  ...
  always @ (*) begin
    ...
    if(_zz_339_)begin
      if(dataCache_1__io_cpu_writeBack_accessError)begin
        DBusCachedPlugin_exceptionBus_payload_code = {1'd0, _zz_397_};
      end
      if(dataCache_1__io_cpu_writeBack_unalignedAccess)begin
        DBusCachedPlugin_exceptionBus_payload_code = {1'd0, _zz_398_};
      end
      if(dataCache_1__io_cpu_writeBack_mmuException)begin
  ...
  assign _zz_177_ = (writeBack_DBusCachedPlugin_rspShifted[7] && (! writeBack_INSTRUCTION[14]));
  always @ (*) begin
    _zz_178_[31] = _zz_177_;
    _zz_178_[30] = _zz_177_;
    _zz_178_[29] = _zz_177_;
    _zz_178_[28] = _zz_177_;
    _zz_178_[27] = _zz_177_;
    _zz_178_[26] = _zz_177_;
    _zz_178_[25] = _zz_177_;
    _zz_178_[24] = _zz_177_;
    _zz_178_[23] = _zz_177_;
    _zz_178_[22] = _zz_177_;
    _zz_178_[21] = _zz_177_;
    _zz_178_[20] = _zz_177_;
    ...
    _zz_178_[9] = _zz_177_;
    _zz_178_[8] = _zz_177_;
    _zz_178_[7 : 0] = writeBack_DBusCachedPlugin_rspShifted[7 : 0];
  end

  assign _zz_179_ = (writeBack_DBusCachedPlugin_rspShifted[15] && (! writeBack_INSTRUCTION[14]));
  always @ (*) begin
    _zz_180_[31] = _zz_179_;
    _zz_180_[30] = _zz_179_;
    _zz_180_[29] = _zz_179_;
    _zz_180_[28] = _zz_179_;
    _zz_180_[27] = _zz_179_;
    _zz_180_[26] = _zz_179_;
    _zz_180_[25] = _zz_179_;
    _zz_180_[24] = _zz_179_;
    _zz_180_[23] = _zz_179_;
    _zz_180_[22] = _zz_179_;
    _zz_180_[21] = _zz_179_;
    _zz_180_[20] = _zz_179_;
    _zz_180_[19] = _zz_179_;
    _zz_180_[18] = _zz_179_;
    _zz_180_[17] = _zz_179_;
    _zz_180_[16] = _zz_179_;
    _zz_180_[15 : 0] = writeBack_DBusCachedPlugin_rspShifted[15 : 0];
  end

  always @ (*) begin
    case(_zz_380_)
      2'b00 : begin
        writeBack_DBusCachedPlugin_rspFormated = _zz_178_;
      end
      2'b01 : begin
        writeBack_DBusCachedPlugin_rspFormated = _zz_180_;
      end
      default : begin
  ...
  assign _zz_182_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000001100)) == (32'b00000000000000000000000000000100));
  assign _zz_183_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001001000)) == (32'b00000000000000000000000001001000));
  assign _zz_184_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001010000)) == (32'b00000000000000000010000000000000));
  assign _zz_185_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000000100)) == (32'b00000000000000000000000000000100));
  assign _zz_186_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000000000)) == (32'b00000000000000000000000000000000));
  assign _zz_187_ = ((decode_INSTRUCTION & (32'b00000000000000000100000001010000)) == (32'b00000000000000000100000001010000));
  assign _zz_181_ = {(((decode_INSTRUCTION & _zz_547_) == (32'b00000000000000000001000000001000)) != (1'b0)),{({_zz_182_,{_zz_548_,_zz_549_}} != (5'b00000)),{(_zz_550_ != (1'b0)),{(_zz_551_ != _zz_552_),{_zz_553_,{_zz_554_,_zz_555_}}}}}};
  assign _zz_93_ = ({((decode_INSTRUCTION & (32'b00000000000000000000000001011111)) == (32'b00000000000000000000000000010111)),{((decode_INSTRUCTION & (32'b00000000000000000000000001111111)) == (32'b00000000000000000000000001101111)),{((decode_INSTRUCTION & (32'b00000000000000000001000001101111)) == (32'b00000000000000000000000000000011)),{((decode_INSTRUCTION & _zz_730_) == (32'b00000000000000000001000001110011)),{(_zz_731_ == _zz_732_),{_zz_733_,{_zz_734_,_zz_735_}}}}}}} != (25'b0000000000000000000000000));
  assign _zz_92_ = _zz_399_[0];
  assign _zz_91_ = _zz_400_[0];
  assign _zz_90_ = _zz_401_[0];
  assign _zz_89_ = _zz_402_[0];
  assign _zz_188_ = _zz_181_[6 : 5];
  assign _zz_88_ = _zz_188_;
  assign _zz_87_ = _zz_403_[0];
  assign _zz_86_ = _zz_404_[0];
  assign _zz_189_ = _zz_181_[10 : 9];
  assign _zz_85_ = _zz_189_;
  assign _zz_190_ = _zz_181_[12 : 11];
  assign _zz_84_ = _zz_190_;
  assign _zz_83_ = _zz_405_[0];
  assign _zz_82_ = _zz_406_[0];
  assign _zz_81_ = _zz_407_[0];
  assign _zz_80_ = _zz_408_[0];
  assign _zz_79_ = _zz_409_[0];
  assign _zz_78_ = _zz_410_[0];
  assign _zz_191_ = _zz_181_[20 : 19];
  assign _zz_77_ = _zz_191_;
  assign _zz_76_ = _zz_411_[0];
  assign _zz_75_ = _zz_412_[0];
  assign _zz_74_ = _zz_413_[0];
  assign _zz_73_ = _zz_414_[0];
  assign _zz_72_ = _zz_415_[0];
  assign _zz_192_ = _zz_181_[27 : 26];
  assign _zz_71_ = _zz_192_;
  assign _zz_70_ = _zz_416_[0];
  assign _zz_193_ = _zz_181_[30 : 29];
  assign _zz_69_ = _zz_193_;
  assign _zz_68_ = _zz_417_[0];
  assign _zz_194_ = _zz_181_[33 : 32];
  assign _zz_67_ = _zz_194_;
  assign _zz_66_ = _zz_418_[0];
  assign _zz_65_ = _zz_419_[0];
  ...
  always @ (*) begin
    case(execute_ALU_CTRL)
      `AluCtrlEnum_defaultEncoding_BITWISE : begin
        _zz_196_ = execute_IntAluPlugin_bitwise;
      end
      `AluCtrlEnum_defaultEncoding_SLT_SLTU : begin
        _zz_196_ = {31'd0, _zz_420_};
      end
      default : begin
        _zz_196_ = execute_SRC_ADD_SUB;
      end
    endcase
  end

  assign _zz_58_ = _zz_196_;
  assign _zz_56_ = (decode_SRC_ADD_ZERO && (! decode_SRC_USE_SUB_LESS));
  always @ (*) begin
    case(execute_SRC1_CTRL)
      `Src1CtrlEnum_defaultEncoding_RS : begin
        _zz_197_ = execute_RS1;
      end
      `Src1CtrlEnum_defaultEncoding_PC_INCREMENT : begin
        _zz_197_ = {29'd0, _zz_421_};
      end
      `Src1CtrlEnum_defaultEncoding_IMU : begin
        _zz_197_ = {execute_INSTRUCTION[31 : 12],(12'b000000000000)};
      end
      default : begin
        _zz_197_ = {27'd0, _zz_422_};
      end
    endcase
  end

  assign _zz_55_ = _zz_197_;
  assign _zz_198_ = _zz_423_[11];
  always @ (*) begin
  ...
  always @ (*) begin
    case(execute_SRC2_CTRL)
      `Src2CtrlEnum_defaultEncoding_RS : begin
        _zz_202_ = execute_RS2;
      end
      `Src2CtrlEnum_defaultEncoding_IMI : begin
        _zz_202_ = {_zz_199_,execute_INSTRUCTION[31 : 20]};
      end
      `Src2CtrlEnum_defaultEncoding_IMS : begin
        _zz_202_ = {_zz_201_,{execute_INSTRUCTION[31 : 25],execute_INSTRUCTION[11 : 7]}};
      end
      default : begin
        _zz_202_ = _zz_51_;
      end
  ...
  assign _zz_53_ = _zz_202_;
  always @ (*) begin
    execute_SrcPlugin_addSub = _zz_425_;
  ...
  always @ (*) begin
    _zz_203_[0] = execute_SRC1[31];
    _zz_203_[1] = execute_SRC1[30];
    _zz_203_[2] = execute_SRC1[29];
    _zz_203_[3] = execute_SRC1[28];
    _zz_203_[4] = execute_SRC1[27];
    _zz_203_[5] = execute_SRC1[26];
    _zz_203_[6] = execute_SRC1[25];
    _zz_203_[7] = execute_SRC1[24];
    _zz_203_[8] = execute_SRC1[23];
    _zz_203_[9] = execute_SRC1[22];
    _zz_203_[10] = execute_SRC1[21];
    _zz_203_[11] = execute_SRC1[20];
    _zz_203_[12] = execute_SRC1[19];
    _zz_203_[13] = execute_SRC1[18];
    _zz_203_[14] = execute_SRC1[17];
    _zz_203_[15] = execute_SRC1[16];
    _zz_203_[16] = execute_SRC1[15];
    _zz_203_[17] = execute_SRC1[14];
    _zz_203_[18] = execute_SRC1[13];
    _zz_203_[19] = execute_SRC1[12];
    _zz_203_[20] = execute_SRC1[11];
    _zz_203_[21] = execute_SRC1[10];
    _zz_203_[22] = execute_SRC1[9];
    _zz_203_[23] = execute_SRC1[8];
    _zz_203_[24] = execute_SRC1[7];
    _zz_203_[25] = execute_SRC1[6];
    _zz_203_[26] = execute_SRC1[5];
    _zz_203_[27] = execute_SRC1[4];
    _zz_203_[28] = execute_SRC1[3];
    _zz_203_[29] = execute_SRC1[2];
    _zz_203_[30] = execute_SRC1[1];
    _zz_203_[31] = execute_SRC1[0];
  end

  assign execute_FullBarrelShifterPlugin_reversed = ((execute_SHIFT_CTRL == `ShiftCtrlEnum_defaultEncoding_SLL_1) ? _zz_203_ : execute_SRC1);
  assign _zz_46_ = _zz_433_;
  always @ (*) begin
    _zz_204_[0] = memory_SHIFT_RIGHT[31];
    _zz_204_[1] = memory_SHIFT_RIGHT[30];
    _zz_204_[2] = memory_SHIFT_RIGHT[29];
    _zz_204_[3] = memory_SHIFT_RIGHT[28];
    _zz_204_[4] = memory_SHIFT_RIGHT[27];
    _zz_204_[5] = memory_SHIFT_RIGHT[26];
    _zz_204_[6] = memory_SHIFT_RIGHT[25];
    _zz_204_[7] = memory_SHIFT_RIGHT[24];
    _zz_204_[8] = memory_SHIFT_RIGHT[23];
    _zz_204_[9] = memory_SHIFT_RIGHT[22];
    _zz_204_[10] = memory_SHIFT_RIGHT[21];
    _zz_204_[11] = memory_SHIFT_RIGHT[20];
    _zz_204_[12] = memory_SHIFT_RIGHT[19];
    _zz_204_[13] = memory_SHIFT_RIGHT[18];
    _zz_204_[14] = memory_SHIFT_RIGHT[17];
    _zz_204_[15] = memory_SHIFT_RIGHT[16];
    _zz_204_[16] = memory_SHIFT_RIGHT[15];
    _zz_204_[17] = memory_SHIFT_RIGHT[14];
    _zz_204_[18] = memory_SHIFT_RIGHT[13];
    _zz_204_[19] = memory_SHIFT_RIGHT[12];
    _zz_204_[20] = memory_SHIFT_RIGHT[11];
    _zz_204_[21] = memory_SHIFT_RIGHT[10];
    _zz_204_[22] = memory_SHIFT_RIGHT[9];
    _zz_204_[23] = memory_SHIFT_RIGHT[8];
    _zz_204_[24] = memory_SHIFT_RIGHT[7];
    _zz_204_[25] = memory_SHIFT_RIGHT[6];
    _zz_204_[26] = memory_SHIFT_RIGHT[5];
    _zz_204_[27] = memory_SHIFT_RIGHT[4];
    _zz_204_[28] = memory_SHIFT_RIGHT[3];
    _zz_204_[29] = memory_SHIFT_RIGHT[2];
    _zz_204_[30] = memory_SHIFT_RIGHT[1];
    _zz_204_[31] = memory_SHIFT_RIGHT[0];
  end
  ...
  assign _zz_207_ = (_zz_61_ && writeBack_arbitration_isFiring);
  assign _zz_211_ = (writeBack_INSTRUCTION[11 : 7] == decode_INSTRUCTION[19 : 15]);
  assign _zz_212_ = (writeBack_INSTRUCTION[11 : 7] == decode_INSTRUCTION[24 : 20]);
  assign _zz_213_ = (memory_INSTRUCTION[11 : 7] == decode_INSTRUCTION[19 : 15]);
  assign _zz_214_ = (memory_INSTRUCTION[11 : 7] == decode_INSTRUCTION[24 : 20]);
  assign _zz_215_ = (execute_INSTRUCTION[11 : 7] == decode_INSTRUCTION[19 : 15]);
  assign _zz_216_ = (execute_INSTRUCTION[11 : 7] == decode_INSTRUCTION[24 : 20]);
  ...
  assign _zz_38_ = ($signed(_zz_435_) + $signed(_zz_443_));
  ...
  assign _zz_217_ = memory_DivPlugin_rs1[31 : 0];
  assign _zz_218_ = {memory_DivPlugin_accumulator[31 : 0],_zz_217_[31]};
  assign _zz_219_ = (_zz_218_ - _zz_450_);
  assign _zz_220_ = (memory_INSTRUCTION[13] ? memory_DivPlugin_accumulator[31 : 0] : memory_DivPlugin_rs1[31 : 0]);
  assign _zz_221_ = (execute_RS2[31] && execute_IS_RS2_SIGNED);
  assign _zz_222_ = (1'b0 || ((execute_IS_DIV && execute_RS1[31]) && execute_IS_RS1_SIGNED));
  always @ (*) begin
    _zz_223_[32] = (execute_IS_RS1_SIGNED && execute_RS1[31]);
    _zz_223_[31 : 0] = execute_RS1;
  end

  always @ (*) begin
    CsrPlugin_privilege = _zz_224_;
  ...
  assign _zz_225_ = (CsrPlugin_sip_STIP && CsrPlugin_sie_STIE);
  assign _zz_226_ = (CsrPlugin_sip_SSIP && CsrPlugin_sie_SSIE);
  assign _zz_227_ = (CsrPlugin_sip_SEIP_OR && CsrPlugin_sie_SEIE);
  assign _zz_228_ = (CsrPlugin_mip_MTIP && CsrPlugin_mie_MTIE);
  assign _zz_229_ = (CsrPlugin_mip_MSIP && CsrPlugin_mie_MSIE);
  assign _zz_230_ = (CsrPlugin_mip_MEIP && CsrPlugin_mie_MEIE);
  always @ (*) begin
  ...
  assign _zz_231_ = {decodeExceptionPort_valid,IBusCachedPlugin_decodeExceptionPort_valid};
  assign _zz_232_ = _zz_463_[0];
  always @ (*) begin
  ...
  always @ (*) begin
    ...
    case(execute_CsrPlugin_csrAddress)
      ...
      12'b100111000000 : begin
        execute_CsrPlugin_readData[31 : 0] = _zz_250_;
      end
      12'b000100000000 : begin
        execute_CsrPlugin_readData[8 : 8] = CsrPlugin_sstatus_SPP;
        execute_CsrPlugin_readData[5 : 5] = CsrPlugin_sstatus_SPIE;
  ...
  assign _zz_233_ = execute_INSTRUCTION[14 : 12];
  always @ (*) begin
    if((_zz_233_ == (3'b000))) begin
        _zz_234_ = execute_BranchPlugin_eq;
    end else if((_zz_233_ == (3'b001))) begin
        _zz_234_ = (! execute_BranchPlugin_eq);
    end else if((((_zz_233_ & (3'b101)) == (3'b101)))) begin
        _zz_234_ = (! execute_SRC_LESS);
    end else begin
        _zz_234_ = execute_SRC_LESS;
    end
  end
  ...
  assign _zz_236_ = _zz_465_[11];
  always @ (*) begin
    _zz_237_[19] = _zz_236_;
    _zz_237_[18] = _zz_236_;
    _zz_237_[17] = _zz_236_;
    _zz_237_[16] = _zz_236_;
    _zz_237_[15] = _zz_236_;
    _zz_237_[14] = _zz_236_;
    _zz_237_[13] = _zz_236_;
    _zz_237_[12] = _zz_236_;
    _zz_237_[11] = _zz_236_;
  ...
  always @ (*) begin
    case(execute_BRANCH_CTRL)
      `BranchCtrlEnum_defaultEncoding_JALR : begin
        execute_BranchPlugin_branch_src2 = {_zz_237_,execute_INSTRUCTION[31 : 20]};
      end
      default : begin
        execute_BranchPlugin_branch_src2 = ((execute_BRANCH_CTRL == `BranchCtrlEnum_defaultEncoding_JAL) ? {{_zz_239_,{{{_zz_753_,execute_INSTRUCTION[19 : 12]},execute_INSTRUCTION[20]},execute_INSTRUCTION[30 : 21]}},1'b0} : {{_zz_241_,{{{_zz_754_,_zz_755_},execute_INSTRUCTION[30 : 25]},execute_INSTRUCTION[11 : 8]}},1'b0});
        if(execute_PREDICTION_HAD_BRANCHED2)begin
          execute_BranchPlugin_branch_src2 = {29'd0, _zz_468_};
        end
      end
    endcase
  end

  assign _zz_238_ = _zz_466_[19];
  always @ (*) begin
  ...
  assign _zz_242_ = (MmuPlugin_ports_0_cacheHits_1 || MmuPlugin_ports_0_cacheHits_3);
  assign _zz_243_ = (MmuPlugin_ports_0_cacheHits_2 || MmuPlugin_ports_0_cacheHits_3);
  ...
  always @ (*) begin
    MmuPlugin_ports_0_entryToReplace_valueNext = (MmuPlugin_ports_0_entryToReplace_value + _zz_470_);
  ...
  assign _zz_245_ = (MmuPlugin_ports_1_cacheHits_1 || MmuPlugin_ports_1_cacheHits_3);
  assign _zz_246_ = (MmuPlugin_ports_1_cacheHits_2 || MmuPlugin_ports_1_cacheHits_3);
  ...
  always @ (*) begin
    MmuPlugin_ports_1_entryToReplace_valueNext = (MmuPlugin_ports_1_entryToReplace_value + _zz_472_);
  ...
  assign MmuPlugin_shared_dBusRsp_pte_V = _zz_473_[0];
  assign MmuPlugin_shared_dBusRsp_pte_R = _zz_474_[0];
  assign MmuPlugin_shared_dBusRsp_pte_W = _zz_475_[0];
  assign MmuPlugin_shared_dBusRsp_pte_X = _zz_476_[0];
  assign MmuPlugin_shared_dBusRsp_pte_U = _zz_477_[0];
  assign MmuPlugin_shared_dBusRsp_pte_G = _zz_478_[0];
  assign MmuPlugin_shared_dBusRsp_pte_A = _zz_479_[0];
  assign MmuPlugin_shared_dBusRsp_pte_D = _zz_480_[0];
  ...
  assign externalInterrupt = (_zz_249_ != (32'b00000000000000000000000000000000));
  assign _zz_251_ = (_zz_250_ & externalInterruptArray_regNext);
  assign externalInterruptS = (_zz_251_ != (32'b00000000000000000000000000000000));
  always @ (*) begin
  ...
  assign _zz_27_ = ((! DebugPlugin_haltIt) && (decode_IS_EBREAK || ((((1'b0 || (DebugPlugin_hardwareBreakpoints_0_valid && (DebugPlugin_hardwareBreakpoints_0_pc == _zz_485_))) || (DebugPlugin_hardwareBreakpoints_1_valid && (DebugPlugin_hardwareBreakpoints_1_pc == _zz_486_))) || (DebugPlugin_hardwareBreakpoints_2_valid && (DebugPlugin_hardwareBreakpoints_2_pc == _zz_487_))) || (DebugPlugin_hardwareBreakpoints_3_valid && (DebugPlugin_hardwareBreakpoints_3_pc == _zz_488_)))));
  ...
  assign iBusWishbone_ADR = {_zz_534_,_zz_255_};
  ...
  always @ (posedge clk) begin
    if(reset) begin
      ...
      IBusCachedPlugin_rspCounter <= _zz_160_;
      IBusCachedPlugin_rspCounter <= (32'b00000000000000000000000000000000);
      _zz_161_ <= 1'b0;
      _zz_168_ <= 1'b0;
      DBusCachedPlugin_rspCounter <= _zz_175_;
      ...
      _zz_250_ <= (32'b00000000000000000000000000000000);
      ...
      if(IBusCachedPlugin_iBusRsp_stages_2_output_ready)begin
        _zz_125_ <= IBusCachedPlugin_iBusRsp_stages_2_output_valid;
      end
      if(IBusCachedPlugin_fetcherflushIt)begin
        _zz_125_ <= 1'b0;
      end
      ...
      if(_zz_355_)begin
        _zz_161_ <= dataCache_1__io_mem_cmd_valid;
      end
      if(dataCache_1__io_mem_cmd_s2mPipe_ready)begin
        _zz_168_ <= dataCache_1__io_mem_cmd_s2mPipe_valid;
      end
      ...
      if(_zz_330_)begin
        _zz_224_ <= CsrPlugin_targetPrivilege;
        case(CsrPlugin_targetPrivilege)
          2'b01 : begin
            CsrPlugin_sstatus_SIE <= 1'b0;
      ...
      if(_zz_331_)begin
        case(_zz_333_)
          2'b11 : begin
            ...
            _zz_224_ <= CsrPlugin_mstatus_MPP;
          end
          2'b01 : begin
            CsrPlugin_sstatus_SPP <= (1'b0);
            CsrPlugin_sstatus_SIE <= CsrPlugin_sstatus_SPIE;
            CsrPlugin_sstatus_SPIE <= 1'b1;
            _zz_224_ <= {(1'b0),CsrPlugin_sstatus_SPP};
          end
          default : begin
          end
        endcase
      end
      execute_CsrPlugin_wfiWake <= ({_zz_230_,{_zz_229_,{_zz_228_,{_zz_227_,{_zz_226_,_zz_225_}}}}} != (6'b000000));
      ...
      case(execute_CsrPlugin_csrAddress)
        ...
        12'b001100000000 : begin
          if(execute_CsrPlugin_writeEnable)begin
            ...
            CsrPlugin_mstatus_MPIE <= _zz_489_[0];
            CsrPlugin_mstatus_MIE <= _zz_490_[0];
            CsrPlugin_sstatus_SPP <= execute_CsrPlugin_writeData[8 : 8];
            CsrPlugin_sstatus_SPIE <= _zz_491_[0];
            CsrPlugin_sstatus_SIE <= _zz_492_[0];
            MmuPlugin_status_mxr <= _zz_493_[0];
            MmuPlugin_status_sum <= _zz_494_[0];
            MmuPlugin_status_mprv <= _zz_495_[0];
          end
        end
        12'b001100000011 : begin
          if(execute_CsrPlugin_writeEnable)begin
            CsrPlugin_mideleg_SE <= _zz_496_[0];
            CsrPlugin_mideleg_ST <= _zz_497_[0];
            CsrPlugin_mideleg_SS <= _zz_498_[0];
          end
        end
        12'b111100010001 : begin
        end
        ...
        12'b100111000000 : begin
          if(execute_CsrPlugin_writeEnable)begin
            _zz_250_ <= execute_CsrPlugin_writeData[31 : 0];
          end
        end
        12'b000100000000 : begin
          if(execute_CsrPlugin_writeEnable)begin
            CsrPlugin_sstatus_SPP <= execute_CsrPlugin_writeData[8 : 8];
            CsrPlugin_sstatus_SPIE <= _zz_500_[0];
            CsrPlugin_sstatus_SIE <= _zz_501_[0];
            MmuPlugin_status_mxr <= _zz_502_[0];
            MmuPlugin_status_sum <= _zz_503_[0];
            MmuPlugin_status_mprv <= _zz_504_[0];
          end
        end
        12'b001100000010 : begin
          if(execute_CsrPlugin_writeEnable)begin
            CsrPlugin_medeleg_EU <= _zz_505_[0];
            CsrPlugin_medeleg_II <= _zz_506_[0];
            CsrPlugin_medeleg_LAF <= _zz_507_[0];
            CsrPlugin_medeleg_LPF <= _zz_508_[0];
            CsrPlugin_medeleg_LAM <= _zz_509_[0];
            CsrPlugin_medeleg_SAF <= _zz_510_[0];
            CsrPlugin_medeleg_IAF <= _zz_511_[0];
            CsrPlugin_medeleg_ES <= _zz_512_[0];
            CsrPlugin_medeleg_IPF <= _zz_513_[0];
            CsrPlugin_medeleg_SPF <= _zz_514_[0];
            CsrPlugin_medeleg_SAM <= _zz_515_[0];
            CsrPlugin_medeleg_IAM <= _zz_516_[0];
          end
        end
        12'b001101000001 : begin
        end
        ...
        12'b000110000000 : begin
          if(execute_CsrPlugin_writeEnable)begin
            MmuPlugin_satp_mode <= _zz_521_[0];
          end
        end
        12'b110011000000 : begin
        end
        ...
        12'b001100000100 : begin
          if(execute_CsrPlugin_writeEnable)begin
            CsrPlugin_mie_MEIE <= _zz_525_[0];
            CsrPlugin_mie_MTIE <= _zz_526_[0];
            CsrPlugin_mie_MSIE <= _zz_527_[0];
        ...
        12'b000100000100 : begin
          if(execute_CsrPlugin_writeEnable)begin
            CsrPlugin_sie_SEIE <= _zz_531_[0];
            CsrPlugin_sie_STIE <= _zz_532_[0];
            CsrPlugin_sie_SSIE <= _zz_533_[0];
          end
        end
        default : begin
        end
  ...
  always @ (posedge clk) begin
    ...
    if(IBusCachedPlugin_iBusRsp_stages_2_output_ready)begin
      _zz_126_ <= IBusCachedPlugin_iBusRsp_stages_2_output_payload;
    end
    if(_zz_334_)begin
    ...
    if(_zz_355_)begin
      _zz_162_ <= dataCache_1__io_mem_cmd_payload_wr;
      _zz_163_ <= dataCache_1__io_mem_cmd_payload_address;
      _zz_164_ <= dataCache_1__io_mem_cmd_payload_data;
      _zz_165_ <= dataCache_1__io_mem_cmd_payload_mask;
      _zz_166_ <= dataCache_1__io_mem_cmd_payload_length;
      _zz_167_ <= dataCache_1__io_mem_cmd_payload_last;
    end
    if(dataCache_1__io_mem_cmd_s2mPipe_ready)begin
      _zz_169_ <= dataCache_1__io_mem_cmd_s2mPipe_payload_wr;
      _zz_170_ <= dataCache_1__io_mem_cmd_s2mPipe_payload_address;
      _zz_171_ <= dataCache_1__io_mem_cmd_s2mPipe_payload_data;
      _zz_172_ <= dataCache_1__io_mem_cmd_s2mPipe_payload_mask;
      _zz_173_ <= dataCache_1__io_mem_cmd_s2mPipe_payload_length;
      _zz_174_ <= dataCache_1__io_mem_cmd_s2mPipe_payload_last;
    end
    if(_zz_207_)begin
      _zz_209_ <= _zz_60_[11 : 7];
      _zz_210_ <= _zz_95_;
    end
    ...
    if(_zz_320_)begin
      if(_zz_329_)begin
        ...
        memory_DivPlugin_accumulator[31 : 0] <= ((! _zz_219_[32]) ? _zz_452_ : _zz_453_);
        if((memory_DivPlugin_div_counter_value == (6'b100000)))begin
    ...
    if(_zz_347_)begin
      ...
      memory_DivPlugin_rs1 <= ((_zz_222_ ? (~ _zz_223_) : _zz_223_) + _zz_460_);
      memory_DivPlugin_rs2 <= ((_zz_221_ ? (~ execute_RS2) : execute_RS2) + _zz_462_);
      memory_DivPlugin_div_needRevert <= ((_zz_222_ ^ (_zz_221_ && (! execute_INSTRUCTION[13]))) && (! (((execute_RS2 == (32'b00000000000000000000000000000000)) && execute_IS_RS2_SIGNED) && (! execute_INSTRUCTION[13]))));
    end
    ...
    if(_zz_325_)begin
      CsrPlugin_exceptionPortCtrl_exceptionContext_code <= (_zz_232_ ? IBusCachedPlugin_decodeExceptionPort_payload_code : decodeExceptionPort_payload_code);
      CsrPlugin_exceptionPortCtrl_exceptionContext_badAddr <= (_zz_232_ ? IBusCachedPlugin_decodeExceptionPort_payload_badAddr : decodeExceptionPort_payload_badAddr);
    end
    if(CsrPlugin_selfException_valid)begin
    ...
    if((! writeBack_arbitration_isStuck))begin
      memory_to_writeBack_FORMAL_PC_NEXT <= _zz_101_;
    end
    if((! memory_arbitration_isStuck))begin
    ...
    case(execute_CsrPlugin_csrAddress)
      ...
      12'b000101000010 : begin
        if(execute_CsrPlugin_writeEnable)begin
          CsrPlugin_scause_interrupt <= _zz_499_[0];
  ...
  always @ (posedge clk) begin
    ...
    _zz_252_ <= debug_bus_cmd_payload_address[2];
    if(debug_bus_cmd_valid)begin
      case(_zz_353_)
        6'b000000 : begin
        end
    ...
    if(debugReset) begin
      ...
      if(debug_bus_cmd_valid)begin
        case(_zz_353_)
          ...
          6'b010000 : begin
            if(debug_bus_cmd_payload_wr)begin
              DebugPlugin_hardwareBreakpoints_0_valid <= _zz_481_[0];
            end
          end
          6'b010001 : begin
            if(debug_bus_cmd_payload_wr)begin
              DebugPlugin_hardwareBreakpoints_1_valid <= _zz_482_[0];
            end
          end
          6'b010010 : begin
            if(debug_bus_cmd_payload_wr)begin
              DebugPlugin_hardwareBreakpoints_2_valid <= _zz_483_[0];
            end
          end
          6'b010011 : begin
            if(debug_bus_cmd_payload_wr)begin
              DebugPlugin_hardwareBreakpoints_3_valid <= _zz_484_[0];
            end
          end
          default : begin
          end
      ...
      _zz_253_ <= (DebugPlugin_stepIt && decode_arbitration_isFiring);
    end
  end
